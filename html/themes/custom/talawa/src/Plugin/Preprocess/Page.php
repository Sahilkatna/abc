...
namespace Drupal\talawa\Plugin\Preprocess;
...
class Page extends PreprocessBase {
  ...
  public function preprocess(array &$variables, $hook, array $info) {
    ...
    $user_pages = array('stream', 'events', 'topics', 'groups', 'members', 'articles', 'following', 'job-opportunities', 'cancel');
    if ((isset($path_args[3]) && (in_array($path_args[3], $user_pages)))) {
      $variables['display_page_title'] = FALSE;
    }
  }
